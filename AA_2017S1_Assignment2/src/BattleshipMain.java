...
import player.BonusPlayer;
import player.GreedyGuessPlayer;
import player.Guess;
import player.MonteCarloGuessPlayer;
import player.Player;
import player.RandomGuessPlayer;
import player.SampleRandomGuessPlayer;
import world.World;
    ...
    public static void main(String[] args) {
        ...
        if (args.length == offset + 5) {
            ...
            if (p1 == null || p2 == null) {
                ...
                System.err.println("Player 1 took " + p1Rounds +  " rounds to destroy opponent's ships.");
                System.err.println("Player 2 took " + p2Rounds +  " rounds to destroy opponent's ships.");
